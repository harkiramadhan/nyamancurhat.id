    ...
    <div class="container">
        ...
        <div class="d-flex align-items-center justify-content-between">
            ...
            <div class="d-flex align-items-center flex-equal">
                ...
                <div class="d-inline d-lg-none" id="kt_header_nav_wrapper"><div class="d-lg-block p-5 p-lg-0" data-kt-drawer="true" data-kt-drawer-name="landing-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="200px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_landing_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav_wrapper'}" style="">
                    ...
                    <div class="menu menu-column flex-nowrap menu-rounded menu-lg-row menu-title-gray-500 menu-state-title-primary nav nav-flush fs-5 fw-bold" id="kt_landing_menu">
                        ...
                        <div class="menu-item">
                            <!--begin::Menu link-->
                            <a href="<?= site_url('cara') ?>" class="btn btn-outline btn-outline-primary btn-active-light-primary mt-3">Cara Curhat</a>
                            <!--end::Menu link-->
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item">
                            <!--begin::Menu link-->
                            <a href="<?= site_url('coach') ?>" class="btn btn-primary mt-3">Coach Profile</a>
                            <!--end::Menu link-->
                        </div>
                        <!--end::Menu item-->
                    </div>
            ...
            <div class="flex-equal text-end ms-1">
                <a href="<?= site_url('cara') ?>" class="btn btn-outline btn-outline-primary btn-active-light-primary d-none d-lg-inline">Cara Curhat</a>
                <a href="<?= site_url('coach') ?>" class="btn btn-primary d-none d-lg-inline">Coach Profile</a>
            </div>
            <!--end::Toolbar-->
        </div>
        <!--end::Wrapper-->
